...
SERVER_COUNT_MACHINE="${SERVER_COUNT_MACHINE:-0}"
# How many agent instances to create
AGENT_COUNT_MACHINE="${AGENT_COUNT_MACHINE:-1}"
# How many CPUs to allocate to each machine
SERVER_CPU_MACHINE="${SERVER_CPU_MACHINE:-2}"
AGENT_CPU_MACHINE="${AGENT_CPU_MACHINE:-1}"
# How much disk space to allocate to each machine
SERVER_DISK_MACHINE="${SERVER_DISK_MACHINE:-5G}"
AGENT_DISK_MACHINE="${AGENT_DISK_MACHINE:-5G}"
# How much memory to allocate to each machine
SERVER_MEMORY_MACHINE="${SERVER_MEMORY_MACHINE:-1G}"
AGENT_MEMORY_MACHINE="${AGENT_MEMORY_MACHINE:-512M}"
